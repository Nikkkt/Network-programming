...
namespace Server
{
    internal class ClientHandler
    {
        ...
        private string PlayGame(string clientChoice)
        {
            ...
            string result = "";
            if (clientChoice == serverChoice) result = "Draw";
            else if ((clientChoice == "Rock" && serverChoice == "Scissors") || (clientChoice == "Scissors" && serverChoice == "Paper") || (clientChoice == "Paper" && serverChoice == "Rock")) result = "You win";
